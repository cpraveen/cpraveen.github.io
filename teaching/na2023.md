...
* Explain how you will index vector/matrix entries, 0-based or 1-based indexing. Make pictures if it helps to explain the ideas.
...
1. Golub and Van Loan, Matrix Computations, HBA.
